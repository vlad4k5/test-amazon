...
const App = () => {
  ...
  const onClickFind = async () => {
    setLoading(true)
    const res = await axios.get(`https://618c282cded7fb0017bb9445.mockapi.io/api/products?name=${searchValue}`)
    setProducts(res.data)
  ...
  return <div className={s.appContainer}>
      ...
      <div className={s.searchWrapper}>
        ...
        <h2 className={s.contentTitle}>{numberOfProducts !== null ? `${products.length} results was found` : "All Products"}</h2>
      </div>
